...
// import icons from "url:../img/icons.svg" //1-versiya
...
const showRecipe = async function() {
    try {
        const id = window.localStorage.hash.slice(1);
        if (!id) return;
        console.log(id);
...
// console.log(renderIng(state.ingredients));
...
},{}]},["ddCAb","aenu9"], "aenu9", "parcelRequire47ec")
